<?php
/**
 * Super Admin layout: collapsible sidebar (Untitled UI style) + main content.
                    ...
                    <div class="portal-notification-wrap">
                        ...
                        <div id="notificationPopup" class="portal-notification-popup" role="menu" aria-label="Notifications" hidden>
                            ...
                            <div class="portal-notification-popup-footer">
                                <a href="<?php echo htmlspecialchars($base_url); ?>#notifications" class="portal-notification-popup-view-all">View all notifications</a>
                            </div>
                        </div>
                    </div>
